...
test("mounting nodes create panel renders compact wizard structure", () => {
  ...
  assert.equal(stylesSource.includes('.mounting-node-create-screen .holes-preview-3d-card {'), true);
  assert.equal(stylesSource.includes('position: sticky;'), true);
  ...
  assert.equal(stylesSource.includes('.hole-bundle-modal-card-image {'), true);
  assert.equal(stylesSource.includes('background: #ffffff;'), true);
  assert.equal(stylesSource.includes('.hole-bundle-modal-card-image-empty {'), true);
  assert.equal(stylesSource.includes('background: #f4f7f9;'), true);
