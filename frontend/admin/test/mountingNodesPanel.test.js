...
test("catalog holes page shows the mounting nodes create mode and editor mode branches", () => {
  ...
  assert.equal(createPanelSource.includes("pointCreateOpen"), true);
  assert.equal(createPanelSource.includes("pointCreateForm"), true);
  assert.equal(createPanelSource.includes("pointCreateFittingId"), true);
  assert.equal(createPanelSource.includes("pointCreateSubmitting"), true);
  assert.equal(createPanelSource.includes("pointCreateOpen ? ("), true);
  assert.equal(createPanelSource.includes("prepareMountingNodeCreateDraftPointForm"), true);
  assert.equal(createPanelSource.includes("commitMountingNodeCreateDraftPoint"), true);
  assert.equal(createPanelSource.includes("setPointCreateOpen(true)"), true);
  assert.equal(createPanelSource.includes("setPointCreateOpen(false)"), true);
  assert.equal(createPanelSource.includes("handlePointCreateSubmit"), true);
  assert.equal(createPanelSource.includes("MountingNodePointFields"), true);
  assert.equal(createPanelSource.includes("getPointTargetPanelOptions"), true);
  assert.equal(createPanelSource.includes("getPointTargetSurfaceOptions"), true);
  assert.equal(createPanelSource.includes("getPointTargetSideOptions"), true);
  assert.equal(createPanelSource.includes("applyMountingNodePointFieldChange"), true);
  assert.equal(createPanelSource.includes("shouldShowSurfaceMountPointTargetFields"), true);
  assert.equal(createPanelSource.includes("createMountingNodeCreateDraftPointFromFitting("), true);
  assert.equal(createPanelSource.includes("points: [...previewPoints.map((point) => ({ ...point, id: point.id })), nextPoint]"), false);
  ...
  assert.equal(createPanelSource.includes("hole-template-error"), true);
