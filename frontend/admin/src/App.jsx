...
import {
  buildHolePointPayload as buildHolePointPayloadHelper,
...
const DEFAULT_HOLE_POINT_FORM = createHolePointFormDefaults();
...
function getHolePointTargetSideLabel(value, mountingVariantKey = "") {
  ...
  switch (String(value || "").trim()) {
    ...
    case "needs_clarification":
      return "Потребує уточнення площини";
    default:
      return "Потребує уточнення";
  }
}
...
function getHolePointTargetSideOptions(targetPanel, targetSurface, currentValue, mountingVariantKey = "") {
  ...
  const addCurrentValue = (options) => {
    if (normalizedCurrentValue && !options.some((option) => option.value === normalizedCurrentValue)) {
      return [...options, { value: normalizedCurrentValue, label: getHolePointTargetSideLabel(normalizedCurrentValue) }];
    }
...
function getHolePointPanelDescription(panelKey) {
  if (panelKey === "horizontal_panel") {
    return "Відредагуйте координати, діаметр і параметри глибини для горизонтальної панелі.";
  }
...
function getHolePointCoordinateHintText(panelKey) {
  return "Початок координат знаходиться у стику внутрішньої площини вертикальної панелі та торця горизонтальної панелі. X, Y, Z рахуються від цієї точки.";
}
...
function isFastenerFitting(item) {
  ...
  return /(СЃР°РјРѕСЂ|СЃС‚СЏР¶|РєРѕРЅС„С–СЂРј|С€СѓСЂСѓРї|РіРІРёРЅС‚|Р±РѕР»С‚|РіР°Р№Рє|РґСЋР±|РјРµС‚РёР·|screw|confirmat)/i.test(
    haystack,
  );
}
...
const TRANSLATIONS = {
  en: {
    ...
    mountingNodeOpenEditor: "Open point editor",
    ...
    holeBundleName: "Bundle name",
    holeBundleNamePlaceholder: "For example: Confirmat + dowel bundle",
    holeBundleCategory: "Fitting category",
    holeBundleCategoryPlaceholder: "Choose a fitting category",
    holeBundleCategoryHint: "Choose a category to open the fitting selector.",
    holeBundleCategorySelected: "Selected category",
    holeBundleModalTitle: "Choose fittings for the bundle",
    holeBundleModalDescription: "Select multiple fittings from this category.",
    holeBundleModeList: "List",
    holeBundleModeCards: "Cards",
    ...
    holePanelGroupHorizontalHelper: "Holes on the edge side of the horizontal panel.",
    holePointAdd: "Add point",
    holePointCreateDescription:
      "Create a new hole point for the selected fitting and mounting variant.",
    ...
    holeTemplateSelectTemplate: "No openings available for this fitting",
...
Object.assign(TRANSLATIONS.uk, {
  ...
  holeBundleName: "\u041d\u0430\u0437\u0432\u0430 \u043a\u043e\u043c\u043f\u043b\u0435\u043a\u0442\u0443",
  holeBundleNamePlaceholder: "\u041d\u0430\u043f\u0440\u0438\u043a\u043b\u0430\u0434: \u041a\u043e\u043c\u043f\u043b\u0435\u043a\u0442 \u043a\u043e\u043d\u0444\u0456\u0440\u043c\u0430\u0442 + \u0448\u043a\u0430\u043d\u0442",
  holeBundleCategory: "\u041a\u0430\u0442\u0435\u0433\u043e\u0440\u0456\u044f \u0444\u0443\u0440\u043d\u0456\u0442\u0443\u0440\u0438",
  holeBundleCategoryPlaceholder: "\u041e\u0431\u0435\u0440\u0456\u0442\u044c \u043a\u0430\u0442\u0435\u0433\u043e\u0440\u0456\u044e \u0444\u0443\u0440\u043d\u0456\u0442\u0443\u0440\u0438",
  holeBundleCategoryHint: "\u041e\u0431\u0435\u0440\u0456\u0442\u044c \u043a\u0430\u0442\u0435\u0433\u043e\u0440\u0456\u044e, \u0449\u043e\u0431 \u0432\u0456\u0434\u043a\u0440\u0438\u0442\u0438 \u0432\u0456\u043a\u043d\u043e \u0432\u0438\u0431\u043e\u0440\u0443 \u0444\u0443\u0440\u043d\u0456\u0442\u0443\u0440\u0438.",
  holeBundleCategorySelected: "\u0412\u0438\u0431\u0440\u0430\u043d\u0430 \u043a\u0430\u0442\u0435\u0433\u043e\u0440\u0456\u044f",
  holeBundleModalTitle: "\u0412\u0438\u0431\u0456\u0440 \u0444\u0443\u0440\u043d\u0456\u0442\u0443\u0440\u0438 \u0434\u043b\u044f \u043a\u043e\u043c\u043f\u043b\u0435\u043a\u0442\u0443",
  holeBundleModalDescription: "\u041e\u0431\u0435\u0440\u0456\u0442\u044c \u043a\u0456\u043b\u044c\u043a\u0430 \u043f\u043e\u0437\u0438\u0446\u0456\u0439 \u0444\u0443\u0440\u043d\u0456\u0442\u0443\u0440\u0438 \u0437 \u0446\u0456\u0454\u0457 \u043a\u0430\u0442\u0435\u0433\u043e\u0440\u0456\u0457.",
  holeBundleModeList: "\u0421\u043f\u0438\u0441\u043e\u043a",
  holeBundleModeCards: "\u041a\u0430\u0440\u0442\u043a\u0438",
  holeBundleModalEmptyTitle: "\u0423 \u0446\u0456\u0439 \u043a\u0430\u0442\u0435\u0433\u043e\u0440\u0456\u0457 \u0449\u0435 \u043d\u0435\u043c\u0430\u0454 \u0444\u0443\u0440\u043d\u0456\u0442\u0443\u0440\u0438.",
  holeBundleModalEmptyDescription: "\u041e\u0431\u0435\u0440\u0456\u0442\u044c \u0456\u043d\u0448\u0443 \u043a\u0430\u0442\u0435\u0433\u043e\u0440\u0456\u044e, \u0449\u043e\u0431 \u043f\u0440\u043e\u0434\u043e\u0432\u0436\u0438\u0442\u0438.",
  holeBundleSelectedItemsTitle: "\u0412\u0438\u0431\u0440\u0430\u043d\u0456 \u043f\u043e\u0437\u0438\u0446\u0456\u0457",
  holeBundleSelectedItemsCount: "\u043f\u043e\u0437\u0438\u0446\u0456\u0439",
  holeBundleItemArticle: "\u0410\u0440\u0442\u0438\u043a\u0443\u043b",
  holeBundleItemCategory: "\u041a\u0430\u0442\u0435\u0433\u043e\u0440\u0456\u044f",
  ...
  holePanelGroupVerticalTitle: "\u0412\u0435\u0440\u0442\u0438\u043a\u0430\u043b\u044c\u043d\u0430 \u043f\u0430\u043d\u0435\u043b\u044c",
  holePanelGroupVerticalHelper: "\u041e\u0442\u0432\u043e\u0440\u0438 \u043d\u0430 \u0444\u0430\u0441\u0430\u0434\u043d\u0456\u0439 \u0447\u0430\u0441\u0442\u0438\u043d\u0456 \u0432\u0435\u0440\u0442\u0438\u043a\u0430\u043b\u044c\u043d\u043e\u0457 \u043f\u0430\u043d\u0435\u043b\u0456.",
  holePanelGroupHorizontalTitle: "\u0413\u043e\u0440\u0438\u0437\u043e\u043d\u0442\u0430\u043b\u044c\u043d\u0430 \u043f\u0430\u043d\u0435\u043b\u044c",
  holePanelGroupHorizontalHelper: "\u041e\u0442\u0432\u043e\u0440\u0438 \u043d\u0430 \u0442\u043e\u0440\u0446\u0456 \u0433\u043e\u0440\u0438\u0437\u043e\u043d\u0442\u0430\u043b\u044c\u043d\u043e\u0457 \u043f\u0430\u043d\u0435\u043b\u0456.",
...
Object.assign(TRANSLATIONS.uk, {
  ...
  settings: "Налаштування",
  users: "Користувачі",
  valueCatalog: "Довідник значень",
  viyarCatalog: "Довідник Viyar",
  home: "Головна",
...
Object.assign(TRANSLATIONS.uk, {
  bathroom_shelf: "Санвузлова полиця",
  bathroom_vanity: "Санвузлова тумба",
  wall_unit: "Стіна",
  projectStartPremiumBadge: "Business",
  projectStartPremiumDescription: "Business-старт: шаблони, скан, PDF та розширені сценарії імпорту для більших робочих процесів.",
  ...
  projectTemplateBathroomShelfDescription: "Компактна санвузлова полиця з малою глибиною та вертикальним зберіганням.",
  projectTemplateBathroomShelfTitle: "Санвузлова полиця",
  ...
  projectTemplateWallUnitDescription: "Стіна для кімнати з широким корпусом і зонами зберігання.",
  projectTemplateWallUnitTitle: "Стіна",
});
...
Object.assign(TRANSLATIONS.uk, {
  ...
  catalog: "Довідники",
  catalogFittings: "Каталог фурнітури",
  catalogFittingsDescription: "Основний асортимент фурнітури для прорахунків з фільтрами по місту та артикулу.",
  catalogFasteners: "З'єднувальна та кріпильна фурнітура",
  catalogFastenersDescription: "Технічна фурнітура: стяжки, саморізи, кріпильні елементи та супутні позиції.",
  catalogMaterials: "Матеріали",
  catalogMaterialsDescription: "Матеріали для виробництва, фільтри та пов’язана довідкова інформація.",
  catalogValues: "Довідник значень",
  catalogViyar: "Довідник Viyar",
  ...
  mountingNodeOpenEditor: "Відкрити редактор точок",
  ...
  holeTemplateFitting: "Фурнітура",
  holeTemplateFittingInfoTitle: "Фурнітура",
  holeTemplateMountingSchemeTitle: "Схема кріплення",
  holeTemplateConnectionVariantTitle: "Варіант кріплення",
  holeTemplateSelectFitting: "Оберіть фурнітуру",
  holeTemplateCreateTitle: "Створення шаблону",
  holeTemplateRefresh: "Оновити",
  holeTemplateSave: "Зберегти",
  holeTemplateSaveChanges: "Зберегти зміни",
  holeTemplateEmpty: "Шаблони ще не створені",
  holeTemplateDelete: "Видалити шаблон",
  holeTemplateDeleteConfirm: "Видалити шаблон?",
  holeTemplateDeleteFailed: "Не вдалося видалити шаблон",
  holeTemplateDeleteSuccess: "Шаблон видалено",
  holeTemplateEditTitle: "Редагування шаблону",
  holeTemplateEditDescription: "Змініть параметри шаблону для вибраної фурнітури.",
  holeTemplateCreateDescription: "Створіть шаблон отворів для вибраної фурнітури.",
  holeTemplateUpdateFailed: "Не вдалося оновити шаблон",
  holeTemplateUpdateSuccess: "Шаблон оновлено",
  holeTemplateName: "Назва",
  holeTemplateNotes: "Нотатки",
  holeTemplateSide: "Сторона",
  holeTemplateTitle: "Шаблони",
  holeTemplateType: "Тип",
  ...
  holeTemplateFittingRequired: "Спочатку виберіть фурнітуру",
...
Object.assign(TRANSLATIONS.uk, {
  ...
  holePointOrderIndex: "Порядок",
  holePointQuantity: "Кількість",
  holePointMirrored: "Дзеркально",
  holePointNotes: "Нотатки",
  holeTemplateColumnName: "Назва",
  holeTemplateColumnSide: "Сторона",
  holeTemplateColumnType: "Тип",
  holeTemplateColumnSystem: "Система",
...
function stripMaterialSizeSuffix(value) {
  ...
  return text
    .replace(/\s+\d{2,4}\s*[xXРЎвЂ¦Р ТђР“вЂ”]\s*\d{2,4}\s*[xXРЎвЂ¦Р ТђР“вЂ”]\s*\d{1,3}\s*(?:Р СР С|mm)?\b.*$/iu, "")
    .trim();
}
...
export default function App() {
  ...
  const holeBundleCategoryItems = useMemo(
    () =>
      holeBundleCategoryCode
        ? fittingItems.filter((item) => item.fitting_type === holeBundleCategoryCode)
        : [],
    [fittingItems, holeBundleCategoryCode],
  );
  const holeBundleSelectedItems = useMemo(
    () =>
      holeBundleSelectedItemIds
        .map((itemId) => fittingItems.find((item) => String(item.id) === String(itemId)))
        .filter(Boolean),
  ...
  const holeBundleCategoryMeta = useMemo(
    () =>
      ...
      null,
    [fittingCategories, holeBundleCategoryCode],
  );
  ...
  useEffect(() => {
    ...
    const firstBundleItem = holeBundleSelectedItems[0];

    if (!firstBundleItem?.id) {
      return;
    }
  ...
  const holePanelGroups = useMemo(() => {
    if (!Array.isArray(holePoints) || !holePoints.length) {
      return [];
    }

    const variantKey = normalizedSelectedHoleMountingVariantKey;
    const panelA = holesMaterialPlanesModel?.planeA || null;
    const panelB = holesMaterialPlanesModel?.planeB || null;
    const groupDefs =
      variantKey === "face_to_edge"
        ? [
            {
              helper: t.holePanelGroupVerticalHelper,
              key: "vertical_panel",
              label: t.holePanelGroupVerticalTitle,
              order: 0,
            },
            {
              helper: t.holePanelGroupHorizontalHelper,
              key: "horizontal_panel",
              label: t.holePanelGroupHorizontalTitle,
              order: 1,
            },
          ]
        : [
    ...
    const fallbackKey = groupDefs[0]?.key || "panel_a";
    ...
    const inferGroupKey = (point) => {
      const explicitGroupKey = String(
      ...
      if (explicitGroupKey) {
        ...
        if (variantKey === "face_to_edge") {
          if (["panel_a", "face", "vertical", "vertical_panel"].includes(explicitGroupKey)) {
            return groupDefs[0]?.key || fallbackKey;
          }

          if (["panel_b", "edge", "horizontal", "horizontal_panel"].includes(explicitGroupKey)) {
      ...
      if (variantKey === "face_to_edge" && targetPanel) {
        return targetPanel;
      }
      ...
      if (variantKey === "face_to_edge") {
        ...
        if (["edge", "left", "right", "top", "bottom"].includes(side)) {
          return groupDefs[1]?.key || fallbackKey;
        }
      }

      if (variantKey === "edge_to_edge") {
      ...
      if (variantKey === "angled_two_planes") {
        const explicitPanelKey = String(
          point?.panelKey || point?.panel_key || point?.panelId || point?.panel_id || targetPanel || "",
        ).trim();

        if (explicitPanelKey === "horizontal_panel" || targetPanel === "horizontal_panel") {
          return groupDefs[1]?.key || fallbackKey;
        }

        if (explicitPanelKey === "vertical_panel" || targetPanel === "vertical_panel") {
          return groupDefs[0]?.key || fallbackKey;
        }

        if (side.includes("horizontal") || side.includes("angled") || side.includes("target")) {
          return groupDefs[1]?.key || fallbackKey;
        }

        if (side.includes("vertical") || side.includes("front")) {
          return groupDefs[0]?.key || fallbackKey;
        }
      }
    ...
    holePoints.forEach((point, index) => {
      const groupKey = inferGroupKey(point, index);
      ...
      if (group) {
        group.points.push(assignedPoint);
      } else {
        unassigned.push(assignedPoint);
      }
    });

    const orderedGroups = [...normalizedGroups.values()]
  ...
  }, [holePoints, holesMaterialPlanesModel, normalizedSelectedHoleMountingVariantKey]);
  function normalizeHolesForScenePreview(
    ...
    const normalizedPoints = (Array.isArray(points) ? points : []).map((point, index) => {
      ...
      const rawPanelKey = String(
        point?.panelKey || point?.panel_key || point?.panelId || point?.panel_id || "",
      ).trim();
      const targetPanel = String(point?.target_panel || "").trim();
      const targetSurface = String(point?.target_surface || "").trim();
      const targetSide = String(point?.target_side || "").trim();
      const inferredAngledPanelKey =
        mountingVariantKey === "angled_two_planes"
          ? Number.isFinite(x) && Math.abs(x) > 0
            ? "horizontal_panel"
            : Number.isFinite(y) && Math.abs(y) > 0
              ? "vertical_panel"
              : ""
          : "";
      ...
      return {
        ...
        panelKey: rawPanelKey || normalizedLocation.targetPanel || targetPanel || inferredAngledPanelKey || "",
        panel_key: rawPanelKey || normalizedLocation.targetPanel || targetPanel || inferredAngledPanelKey || "",
    ...
    if (pointsWithCoordinates.length) {
      ...
      return {
        ...
        normalizedHoles: normalizedPoints.map((point, index) => {
          ...
          return {
        ...point,
        panelKey: point.panelKey,
        panel_key: point.panel_key,
        isSelected: String(selectedHolePointId) === String(point.id),
        previewX: clampedX,
        previewY: clampedY,
      };
  ...
  const showSurfaceMountPointTargetFields = shouldShowSurfaceMountPointTargetFields(
    normalizedSelectedHoleMountingVariantKey,
  );
  const showAngledTwoPlanesPanelField = normalizedSelectedHoleMountingVariantKey === "angled_two_planes";
  const holePointCreatePanelKey =
    holePointCreateForm.target_panel ||
  ...
  const holePointEditPanelKey =
    holePointEditForm.target_panel || holePointEditForm.panel_key || selectedHolePointPanelKey || "";
  ...
  const inferStatusTone = useCallback((message) => {
    ...
    if (
      /unable|failed|invalid|error|restricted|not found|РїС—Р…РїС—Р… РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р… РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…/.test(normalizedMessage)
    ) {
      return "error";
    }

    if (
      /saved|updated|created|connected|queued|synced|deleted|confirmed|requested|loaded from cache|applied|success|working|РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…|РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…РїС—Р…/.test(normalizedMessage)
    ) {
      return "success";
    }
  ...
  async function loadFittingBundles(activeToken = token) {
    if (!activeToken) {
  ...
  function getFittingBundleCategoryLabel(item) {
    ...
    const category =
      (Array.isArray(visibleFittingCategories)
        ? visibleFittingCategories.find((entry) => entry?.code === categoryCode)
        : null) ||
      (Array.isArray(fittingCategories)
        ? fittingCategories.find((entry) => entry?.code === categoryCode)
        : null);

    return String(category?.name || "").trim();
  }

  function getFittingBundleItemName(item) {
    return String(item?.name || item?.article || item?.code || "").trim() || t.notSet;
  }

  function getFittingBundleItemArticle(item) {
    return String(item?.article || item?.display_article || item?.code || "").trim();
  }

  function getFittingBundleItemImageUrl(item) {
  ...
  function handleHoleBundleCategoryChange(nextCategoryCode) {
    const normalizedCategoryCode = String(nextCategoryCode || "").trim();

    setHoleBundleCategoryCode(normalizedCategoryCode);
    ...
    setHoleBundleDraftItemIds(
      holeBundleCategoryCode === normalizedCategoryCode ? holeBundleSelectedItemIds : [],
    );
    setHoleBundleModalOpen(true);
  }

  function toggleHoleBundleDraftItem(itemId) {
    ...
    setHoleBundleDraftItemIds((current) =>
      current.includes(normalizedItemId)
        ? current.filter((existingId) => existingId !== normalizedItemId)
        : [...current, normalizedItemId],
    );
  }

  function closeHoleBundleModal() {
    setHoleBundleModalOpen(false);
...
function buildSurfaceMountHoleQuaternion(inwardNormal) {
  ...
  async function openHolePointCreateForm() {
    ...
    const isAngledTwoPlanesVariant = normalizedSelectedHoleMountingVariantKey === "angled_two_planes";
    const defaultTargetSurface = isAngledTwoPlanesVariant
      ? "plane"
      : defaultTargetPanel === "horizontal_panel"
        ? "edge"
        : "plane";
    const defaultTargetSide = isAngledTwoPlanesVariant
      ? "inner_face"
      : defaultTargetPanel === "horizontal_panel"
        ? "edge_near_vertical"
        : "inner_face";
    const preset = isSurfaceMountVariant
      ? getSurfaceMountPointFormPreset()
      : normalizedSelectedHoleMountingVariantKey === "angled_two_planes"
    ...
    setHolePointCreateForm({
      ...
      panel_key: defaultTargetPanel,
      target_panel: defaultTargetPanel,
  ...
  function buildHolePointPayload(form) {
    return buildHolePointPayloadHelper(form, {
      variantKey: normalizedSelectedHoleMountingVariantKey,
  ...
  async function handleHolePointEdit(event) {
    ...
    try {
      const existingPoint =
        holePoints.find((point) => String(point?.id || "") === String(holePointEditPointId || "")) ||
        selectedHolePoint ||
        null;
      ...
      const payload = buildHolePointPayload(
        selectedPanelValue
          ? {
              ...holePointEditForm,
              panel_key: selectedPanelValue,
              target_panel: selectedPanelValue,
            }
          : holePointEditForm,
      );
      ...
      const nextTemplateId = String(
        responsePoint?.template_id ||
          existingPoint?.template_id ||
          holeSelectedTemplateId ||
          "",
      ).trim();
      ...
      if (mergedPoint) {
        setHolePoints((current) =>
          current.map((point) =>
            String(point?.id || "") === String(mergedPoint.id || holePointEditPointId)
              ? {
                  ...point,
                  ...mergedPoint,
                }
      ...
      closeHolePointEditForm();
      const reloaded = await loadHoleTemplateDetails(token, nextTemplateId || holeSelectedTemplateId);
      holeMountingVariantRefreshRef.current = { reason: "", templateId: "", variantKey: "" };
      if (reloaded) {
  ...
  async function loadHoleTemplateDetails(
    ...
    const templateListMatchByVariant =
      holeTemplateItems.find(
        (item) =>
          normalizeHoleMountingVariantKey(item?.mounting_variant_key) === currentVariantKey,
      ) || null;
    const templateResultMountingVariantKey = String(templateResult.template?.mounting_variant_key || "").trim();
    const templateResultMatchesCurrentVariant =
      currentVariantKey &&
      templateResultMountingVariantKey &&
      normalizeHoleMountingVariantKey(templateResultMountingVariantKey) === currentVariantKey;
    const nextTemplateBySelectedVariant =
      currentVariantKey
        ? templateListMatchByVariant ||
          (templateResultMatchesCurrentVariant ? templateResult.template : null)
        : null;
    const nextTemplate =
      preserveTemplateId && String(templateId) === preserveTemplateId && preserveVariantKey
        ? templateResult.template || templateListMatchById || holeSelectedTemplate || null
        : currentVariantKey
          ? nextTemplateBySelectedVariant || null
          : templateResult.template || templateListMatchById || templateListMatchByVariant || holeSelectedTemplate || null;

    if (preserveTemplateId && String(templateId) === preserveTemplateId && preserveVariantKey) {
      setSelectedHoleMountingVariantKey(normalizeHoleMountingVariantKey(preserveVariantKey));
      holeMountingVariantRefreshRef.current = { reason: "", templateId: "", variantKey: "" };
    } else if (!currentVariantKey) {
      const nextTemplateMountingVariantKey = String(nextTemplate?.mounting_variant_key || "").trim();
      if (nextTemplateMountingVariantKey) {
        setSelectedHoleMountingVariantKey(normalizeHoleMountingVariantKey(nextTemplateMountingVariantKey));
      }
    }
                      ...
                      <div className="holes-panel-groups">
                        {holePanelGroups.map((group) => (
                          <section className="holes-panel-group" key={group.key}>
                            <div className="holes-panel-group-header">
                              <div className="holes-panel-group-copy">
                                <strong>{group.label}</strong>
                                {group.helper ? <span>{group.helper}</span> : null}
                              </div>
                              <span className="service-tree-badge subtle">{group.points.length}</span>
                            </div>
                ...
                <section className={`holes-preview-card holes-preview-3d-card${holeWorkspaceCanPreview ? "" : " is-placeholder"}`}>
                  ...
                  shouldRenderAngledTwoPlanesThreePreview(normalizedSelectedHoleMountingVariantKey) ? (
                    <HolesMountingThreePreview
                      ...
                      renderSchematicPreview={renderHolesSceneSchematicPreview}
                      selectedHoleId={selectedHolePointId}
                    />
                  ) : (
          ...
          <section className="table-panel full-panel" key="catalogBundles">
            <article className="catalog-card service-catalog-card service-catalog-card-full">
              ...
              {fittingBundlesLoading && !fittingBundleItems.length ? (
                ...
                <div className="fitting-bundles-list">
                  {fittingBundleItems.map((bundle, index) => {
                    ...
                    const bundleDateText = bundleUpdatedAt
                      ? (() => {
                          const parsed = new Date(bundleUpdatedAt);
                ...
                <div className="empty-state compact-empty-state fitting-bundles-empty-state">
                  <strong>{t.fittingBundlesEmptyTitle}</strong>
                  <span>{t.fittingBundlesEmptyDescription}</span>
                </div>
              )}
            </article>
          </section>
      ...
      {holeBundleModalOpen ? (
        ...
        >
          ...
          >
            <header className="confirm-header">
              <div>
                <strong>{t.holeBundleModalTitle}</strong>
                <p>{t.holeBundleModalDescription}</p>
              </div>
              <button
                aria-label={t.cancel}
                className="ghost-button compact-button detail-info-button"
            ...
            <div className="hole-bundle-modal-toolbar">
              <div className="hole-bundle-modal-mode-switch">
                <button
                  className={`ghost-button compact-button${holeBundleModalViewMode === "list" ? " active" : ""}`}
                  onClick={() => setHoleBundleModalViewMode("list")}
                  type="button"
                >
                  {t.holeBundleModeList}
                </button>
                <button
                  className={`ghost-button compact-button${holeBundleModalViewMode === "cards" ? " active" : ""}`}
                  onClick={() => setHoleBundleModalViewMode("cards")}
                  type="button"
                >
                  {t.holeBundleModeCards}
                </button>
              </div>
              <span className="service-tree-badge subtle">
                {holeBundleDraftItemIds.length} {t.holeBundleSelectedItemsCount}
              </span>
            </div>

            {holeBundleCategoryItems.length ? (
              <div
                className={`hole-bundle-modal-body${holeBundleModalViewMode === "cards" ? " is-cards" : " is-list"}`}
              >
                {holeBundleModalViewMode === "list" ? (
                  <div className="hole-bundle-modal-list">
                    {holeBundleCategoryItems.map((item) => {
                      const itemId = String(item.id);
                      const isSelected = holeBundleDraftItemIds.includes(itemId);
                      const itemName = getFittingBundleItemName(item);
                      const itemArticle = getFittingBundleItemArticle(item);
                      const itemImageUrl = getFittingBundleItemImageUrl(item);
                      const itemCategoryLabel = getFittingBundleCategoryLabel(item);
                      ...
                      return (
                        <button
                          ...
                          className={`hole-bundle-modal-row${isSelected ? " is-selected" : ""}`}
                          key={itemId}
                          onClick={() => toggleHoleBundleDraftItem(itemId)}
                          type="button"
                        >
                          ...
                          <span className="hole-bundle-modal-row-media">
                            {itemImageUrl ? (
                              ...
                              <span>{t.holeWorkspaceNoImage}</span>
                            )}
                          </span>
                          <span className="hole-bundle-modal-row-copy">
                            <strong>{itemName}</strong>
                            {itemArticle || itemCategoryLabel ? (
                              <span>
                                {itemArticle ? `${t.holeBundleItemArticle}: ${itemArticle}` : itemCategoryLabel}
                              </span>
                            ) : null}
                          </span>
                          {itemCategoryLabel ? (
                            <span className="hole-bundle-modal-row-meta">{itemCategoryLabel}</span>
                          ) : null}
                        </button>
                      );
                    })}
                  ...
                  <div className="hole-bundle-modal-cards">
                    {holeBundleCategoryItems.map((item) => {
                      ...
                      return (
                        <button
                          aria-pressed={isSelected}
                          className={`hole-bundle-modal-card${isSelected ? " is-selected" : ""}`}
                          key={itemId}
                          onClick={() => toggleHoleBundleDraftItem(itemId)}
                          type="button"
                        >
                          ...
                          <div className="hole-bundle-modal-card-copy">
                            ...
                            <div className="hole-bundle-modal-card-footer">
                              {itemCategoryLabel ? <span>{itemCategoryLabel}</span> : null}
                              <span>{isSelected ? t.holeBundleItemSelected : t.holeBundleItemAdd}</span>
                            </div>
                          </div>
                        </button>
                      );
              ...
              <div className="empty-state compact-empty-state">
                <strong>{t.holeBundleModalEmptyTitle}</strong>
                <span>{t.holeBundleModalEmptyDescription}</span>
              </div>
            )}

            <div className="confirm-actions hole-bundle-actions">
              <button className="ghost-button" onClick={closeHoleBundleModal} type="button">
                {t.cancel}
              </button>
              <button
                className="primary-button"
                disabled={!holeBundleDraftItemIds.length}
                onClick={createHoleBundleDraft}
                type="button"
              >
                <Plus size={16} />
                {t.create}
        ...
        >
          ...
          >
            ...
            <form className="hole-template-form" onSubmit={handleHolePointCreate}>
              ...
              {showSurfaceMountPointTargetFields && !showAngledTwoPlanesPanelField ? (
                <div className="hole-template-form-grid">
                  <label>
                    Деталь для отвору
                    <select
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      setHolePointCreateForm((current) => ({
                        ...
                        depth_mm: event.target.checked ? "" : current.depth_mm,
                      }))
                    }
                    type="checkbox"
                  />
