...
SYSTEM_ENTITLEMENT_REGISTRY: tuple[EntitlementRegistryFeature, ...] = (
    ...
    EntitlementRegistryFeature(
        ...
        name_uk="Перегляд монтажних вузлів",
        description_uk="Дозволяє переглядати список та деталі монтажних вузлів.",
        category="mounting_nodes",
        value_type="boolean",
        sort_order=10,
    ),
    EntitlementRegistryFeature(
        feature_key="mounting_nodes.create",
        name_uk="Створення власних монтажних вузлів",
        description_uk="Дозволяє створювати власні приватні монтажні вузли.",
        category="mounting_nodes",
        value_type="boolean",
        sort_order=20,
    ),
    EntitlementRegistryFeature(
        feature_key="mounting_nodes.edit",
        name_uk="Редагування власних монтажних вузлів",
        description_uk="Дозволяє редагувати лише власні приватні монтажні вузли.",
        category="mounting_nodes",
        value_type="boolean",
        sort_order=30,
    ),
    EntitlementRegistryFeature(
        feature_key="mounting_nodes.delete",
        name_uk="Видалення власних монтажних вузлів",
        description_uk="Дозволяє видаляти лише власні приватні монтажні вузли.",
        category="mounting_nodes",
        value_type="boolean",
        sort_order=40,
    ),
