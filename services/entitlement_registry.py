...
SYSTEM_ENTITLEMENT_REGISTRY: tuple[EntitlementRegistryFeature, ...] = (
    ...
    EntitlementRegistryFeature(
        ...
        name_uk="Додавання матеріалів",
        description_uk="Дозволяє створювати нові матеріали в каталозі.",
        category="materials",
        value_type="boolean",
        sort_order=20,
    ),
    EntitlementRegistryFeature(
        ...
        name_uk="Редагування матеріалів",
        description_uk="Дозволяє редагувати наявні матеріали в каталозі.",
        category="materials",
        value_type="boolean",
        sort_order=30,
    ),
    EntitlementRegistryFeature(
        ...
        name_uk="Видалення матеріалів",
        description_uk="Дозволяє видаляти матеріали з каталогу.",
        category="materials",
        value_type="boolean",
        sort_order=40,
    ),
    ...
    EntitlementRegistryFeature(
        ...
        name_uk="Додавання фурнітури",
        description_uk="Дозволяє створювати нові позиції фурнітури.",
        category="fittings",
        value_type="boolean",
        sort_order=20,
    ),
    EntitlementRegistryFeature(
        ...
        name_uk="Редагування фурнітури",
        description_uk="Дозволяє редагувати позиції фурнітури.",
        category="fittings",
        value_type="boolean",
        sort_order=30,
    ),
    EntitlementRegistryFeature(
        ...
        name_uk="Видалення фурнітури",
        description_uk="Дозволяє видаляти позиції фурнітури.",
        category="fittings",
        value_type="boolean",
        sort_order=40,
    ),
